...
namespace ArrayUtilities
{
	...
	inline paged_2d_array_header<Inumber_of_x_axis_items, Imax_y_items, Imax_total_y_items, Ipage_size>::virtual_memory_map_type::real_address  paged_2d_array_header<Inumber_of_x_axis_items, Imax_y_items, Imax_total_y_items, Ipage_size>::push_back(x_axis_count_type x_axis_index)
	{
		...
		virtual_memory_map_type::real_address_type address_to_write_to = virtual_memory_lookup[x_axis_index].resolve_address_using_virtual_page_offset(new_y_address, virtual_page_number);
	...
	inline void paged_2d_array_header<Inumber_of_x_axis_items, Imax_y_items, Imax_total_y_items, Ipage_size>::pop_back(x_axis_count_type x_axis_index)
	{
		...
		virtual_memory_map_type::virtual_address_type address_to_pop = virtual_memory_map_type::virtual_address_type{ --y_axis_count[x_axis_index] };
